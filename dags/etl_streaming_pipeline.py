...
log_key = f"logs/scheduler/etl_streaming_pipeline_{datetime.now().strftime('%Y%m%d_%H%M%S')}.log"
...
with DAG(
    ...
    extract_metadata >> extract_streaming >> validate_data >> transform_kpis >> load_redshift